package by.epam.nickgrudnitsky.mentoring.homework1.task5to7.service;


import by.epam.nickgrudnitsky.mentoring.homework1.task5to7.entity.output.Printer;
import by.epam.nickgrudnitsky.mentoring.homework1.task5to7.entity.problem.BirthdayProblem;
import by.epam.nickgrudnitsky.mentoring.homework1.task5to7.entity.problem.MarriageProblem;
import by.epam.nickgrudnitsky.mentoring.homework1.task5to7.entity.problem.MontyHallProblem;
import by.epam.nickgrudnitsky.mentoring.homework1.task5to7.entity.problem.Problem;

import java.util.HashMap;
import java.util.Map;

import static by.epam.nickgrudnitsky.mentoring.homework1.task5to7.util.DataInput.readNumber;
import static by.epam.nickgrudnitsky.mentoring.homework1.task5to7.util.Validator.validateMenuItem;
